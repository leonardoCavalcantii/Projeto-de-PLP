...
cadastraPaciente :-
	...
	nl,
	(get_emails_paciente(Emails), member(Email, Emails) -> nl, writeln("Email já cadastrado."), nl;
	assertz(cliente(Nome, CPF, Email, Telefone, Peso, Idade, Grupo_Sanguineo, Email, Senha)),
	adicionaPacietne,
